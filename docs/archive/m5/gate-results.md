...
| Phase 5 — scaffold pivot | 🚧 PENDING PUBLISH | `create-soa-agent@1.0.0-rc.3` — `--memory=<sqlite|mem0|zep|none>` flag, default sqlite; 4 templates (sqlite/mem0/zep/none); deployment docs for each backend; 12/12 scaffold tests green |
